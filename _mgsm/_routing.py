...
def routing(args):
    ...
    # load datasets
    SEARCHING_MODE = True
    examples =  get_all_examples()  # first one and the last one is for few-shot examples
    random.seed(args.shuffle_seed)
    random.shuffle(examples)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_dir', type=str, default='results/mgsm/cumulative/')
    ...
    for save_dir in ["results/mgsm/cumulative/", "results/mgsm/parallel/", "results/mgsm/topk/"]:
